...
public interface Constant {
	...
	String LT_REPORT_DISPLAY_NAME = "LambdaTest Pipeline Report";
	...
	String LT_TUNNEL = "LT_TUNNEL";

	  // Product
	String AUTOMATION = "automation";
	String APP_AUTOMATION = "app-automation";
	
	String JENKINS_BUILD_TAG = "BUILD_TAG";
	
	String LT_REPORT_PIPELINE_FUNCTION = "lambdaTestReportPublisher";
	...
	interface Report {
		...
		public static final String BUILD_APP_INFO_URL = "https://mobile-api.lambdatest.com/mobile-automation/api/v1/builds";
		
		public static final String SESSION_INFO_URL = "https://api.lambdatest.com/automation/api/v1/sessions";
		public static final String SESSION_APP_INFO_URL = "https://mobile-api.lambdatest.com/mobile-automation/api/v1/sessions";
	}
